...
const GRN_MNT = "#52b788"; const GRN_OSC = "#1a2a4a"; const GRN_MED = "#2d6a4f";
...
function App() {
  ...
  const headerEl = e('div', { style: { background: `linear-gradient(90deg, ${GRN_OSC}, ${GRN_MED})`, padding: "14px 16px", display: "flex", justifyContent: "space-between", alignItems: "center" } },
    e('div', null,
      ...
      e('div', { style: { fontSize: 20, fontWeight: "bold", color: GRN_XL, marginTop: 2 } }, "Lista Mayorista"),
      e('div', { style: { fontSize: 10, color: GRN_MNT, marginTop: 1 } }, `Lista mayorista · ${FECHA_LISTA}`)
    ),
              ...
              e('div', {
                ...
                e('div', null,
                  ...
                  (v.litros || v.peso_kg) && e('div', { style: { display: "flex", gap: 8, marginTop: 2 } },
                    v.litros && e('span', { style: { fontSize: 10, color: "#555", background: "#0d1a2a", padding: "1px 6px", borderRadius: 8 } }, `🪣 ${v.litros}L`),
                    v.peso_kg && e('span', { style: { fontSize: 10, color: "#555", background: "#0d1a2a", padding: "1px 6px", borderRadius: 8 } }, `⚖ ${v.peso_kg}kg`)
                  )
                ),
  ...
  const vistaPresupuesto = e('div', { style: { padding: "12px 14px" } },
    ...
    presupuesto.length > 0 && e('div', { style: { display: "flex", flexDirection: "column", gap: 8, marginTop: 10 } },
      ...
      textoVisible?.idx === "json" && e('div', { style: { background: "#0d1a2a", border: `1px solid ${GRN}`, borderRadius: 8, padding: "12px 14px" } },
  ...
  return e('div', { style: { minHeight: "100vh", background: "#0f1923", fontFamily: "'Georgia', serif", maxWidth: 480, margin: "0 auto" } },
    headerEl,
    tabsEl,
